defmodule CitypopsongsWeb.TrackControllerTest do
  use CitypopsongsWeb.ConnCase

  alias Citypopsongs.Multimedia

  @create_attrs %{artist: "some artist", slug: "some slug", title: "some title"}
  ...
  def fixture(:track) do
    {:ok, track} = Multimedia.create_track(@create_attrs)
    track
  end
